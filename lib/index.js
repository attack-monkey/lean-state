...
var fromStateOnce_ = function (state) { return function (fn) {
    fn(state);
}; };
...
var fromNextState_ = function (subs) { return function (subKey, stateKeys, fn) {
    var subs_ = subs;
    stateKeys.forEach(function (stateKey) {
        subs_[stateKey] = subs_[stateKey] ? subs_[stateKey] : {};
        subs_[stateKey][subKey] = fn;
